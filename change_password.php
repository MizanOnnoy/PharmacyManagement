          ...
          <div class="row col col-md-6">
            ...
            <div class="row col col-md-12 m-auto" id="change">
              ...
              <div id="change_button" class="col col-md-5 form-group float-right">
                <button style="font-size: 15px;" class="btn btn-warning form-control font-weight-bold" onclick="changePassword();">Reset Password</button>
              </div>
              <div id="password_button" class="col col-md-4 form-group float-right m-auto">
