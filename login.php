  ...
  <body>
    <div class="container">
      ...
      <div id="forgot-password-form" class="card m-auto p-2" style="display: none;">
        <div class="card-body">
          <div name="login-form" class="login-form">
            ...
            <div id="email-number-fields">
              <p class="h6 text-center text-dark">Enter email and contact number below to reset username and password<p>
              <div class="input-group form-group">
                <div class="input-group-prepend">
        ...
        <div class="card-footer">
          <div class="text-center">
            <a class="text-dark" onclick="displayLoginForm();" style="cursor: pointer;">Login here</a>
          </div>
        </div> <!-- cord-footer class -->
      </div> <!-- card class -->
